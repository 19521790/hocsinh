...
public class MainForm extends javax.swing.JFrame {
    ...
    private NhapLopPanel mNhapLopPanel;
    private SearchStudentPanel mSearchStudent;
    private BangDiemMonPanel mNhanbangdiem;
    private BaoCaoTongKetMonPanel mBaoCaoTongKet;
    private ThayDoiQuyDinhPanel mThayDoiQuyDinh;
    /**
    ...
    private void BaoCaoTongKetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BaoCaoTongKetActionPerformed
        if (mBaoCaoTongKet==null){
            mBaoCaoTongKet= new BaoCaoTongKetMonPanel();
    ...
    private void mnuManageStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuManageStudentActionPerformed
        if (mStudentPanel == null) {
            ...
            tblMainBoard.addTab("Tiếp nhận học sinh", null, mStudentPanel, "Nhập học sinh");
        }
        tblMainBoard.setSelectedComponent(mStudentPanel);
    ...
    private void NhaplopBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NhaplopBtnActionPerformed
        if (mNhapLopPanel==null){
            mNhapLopPanel= new NhapLopPanel();
            tblMainBoard.addTab("Lập danh sách lớp",null, mNhapLopPanel);
        }
        tblMainBoard.setSelectedComponent(mNhapLopPanel);
    ...
    private void TracuuhocsinhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TracuuhocsinhActionPerformed
        if (mSearchStudent==null){
            mSearchStudent= new SearchStudentPanel();
            tblMainBoard.addTab("Tra cứu học sinh", null, mSearchStudent);
        }
        tblMainBoard.setSelectedComponent(mSearchStudent);
    ...
    private void NhanBangDiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NhanBangDiemActionPerformed
        if (mNhanbangdiem== null){
            mNhanbangdiem= new BangDiemMonPanel();
    ...
    private void ThayDoiQuyDinhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ThayDoiQuyDinhActionPerformed
        if (mThayDoiQuyDinh==null){
            mThayDoiQuyDinh= new ThayDoiQuyDinhPanel();
